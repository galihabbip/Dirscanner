...
def IYABUKAN(self, domain):
		try:
			...
			r = requests.get(domain, headers={
			                 "user-agent": "Mozilla/5.0 (Linux; Android 7.0; SM-G892A Bulid/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/60.0.3112.107 Moblie Safari/537.36"}, timeout=20, allow_redirects=False)
